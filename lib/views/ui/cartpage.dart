...
import 'package:online_shoes_app/controllers/cart_provider.dart';
...
import 'package:online_shoes_app/views/shared/checkout_btn.dart';
      ...
      body: Padding(
        ...
        child: Stack(
          children: [
            ...
            cartProvider.checkout.isNotEmpty ? const Align(alignment: Alignment.bottomCenter,
            child: CheckoutButton(label: "Proceed to Checkout"),): const SizedBox.shrink()
          ],
        ),
      ),
    );
